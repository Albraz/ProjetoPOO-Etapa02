public class Fisioterapeuta extends Profissional {
    ...
    public Fisioterapeuta(String nome, String especialidade, String registro, double valorConsulta) {
        super(nome, especialidade, registro, valorConsulta);
    }

    //Construtor Completo
    public Fisioterapeuta(String nome, String especialidade, String registro, double valorConsulta, String[] diasDisponiveis, int totalDias) {
